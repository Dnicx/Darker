...
public class Skull extends Enemy {
	...
	/**
	 * create skull mob with default status position = 0, 0 hp = 5 speed = 5
	 * damage = 2
	 */
	public Skull() {
		super();
	...
	/**
	 * create skull mob  with default status but specific position hp = 5 speed =
	 * 5 damage = 2
	 * 
	 * @param positionX
	...
	/**
	 * create skull mob  with custom status
	 * 
	 * @param positionX
	 *            : position x
	 * @param positionY
	...
	protected void loadIdleLeft() {
		...
		this.idleLeft = new Animation(RenderableHolder.getInstance().skullMonsterSprite, frameWidth, frameHeight,
				idleFrameCount, 2, 3);
	...
	protected void loadWalkLeft() {
		// TODO Auto-generated method stub
		this.walkLeft = new Animation(RenderableHolder.getInstance().skullMonsterSprite, frameWidth, frameHeight,
				walkFrameCount, 2, 4);
	...
	protected void loadAttackLeft() {
		// TODO Auto-generated method stub
		this.attackLeft = new SequenceAnimation(RenderableHolder.getInstance().skullMonsterSprite, frameWidth,
