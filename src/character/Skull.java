...
public class Skull extends Enemy {
	...
	private static final int attackFrameCount = 4;
	 ...
	 * @param damage
	 */
	public Skull(int positionX, int positionY, int hp, int speed, int damage) {
	...
	protected void loadIdleLeft() {
		...
		this.idleLeft = new Animation(RenderableHolder.getInstance().skullMonsterSprite, frameWidth, frameHeight, idleFrameCount, 2, 3);
	...
	protected void loadIdleRight() {
		// TODO Auto-generated method stub
		this.idleRight = new Animation(RenderableHolder.getInstance().skullMonsterSprite, frameWidth, frameHeight, idleFrameCount, 2, 0);
	...
	protected void loadWalkLeft() {
		// TODO Auto-generated method stub
		this.walkLeft = new Animation(RenderableHolder.getInstance().skullMonsterSprite, frameWidth, frameHeight, walkFrameCount, 2, 4);
	...
	protected void loadWalkRight() {
		// TODO Auto-generated method stub
		this.walkRight = new Animation(RenderableHolder.getInstance().skullMonsterSprite, frameWidth, frameHeight, walkFrameCount, 2, 1);
	...
	protected void loadAttackLeft() {
		// TODO Auto-generated method stub
		this.attackLeft = new SequenceAnimation(RenderableHolder.getInstance().skullMonsterSprite, frameWidth, frameHeight, attackFrameCount, 2, 5);
	...
	protected void loadAttackRight() {
		// TODO Auto-generated method stub
		this.attackRight = new SequenceAnimation(RenderableHolder.getInstance().skullMonsterSprite, frameWidth, frameHeight, attackFrameCount, 2, 2);
