...
public class Cute extends Enemy {
	...
	private static final int attackFrameCount = 6;

	private static final int attackRange = 16;
	private static final int attackFrame = 4;

	/**
	 * create cute mob with default status position = 0, 0 hp = 5 speed = 5
	 * damage = 2
	 */
	public Cute() {
		super();
	...
	/**
	 * create cute mob with default status but specific position hp = 5 speed =
	 * 5 damage = 2
	 * 
	 * @param positionX
	 ...
	 */
	public Cute(int positionX, int positionY) {
	...
	/**
	 * create cute mob with custom status
	 * 
	 * @param positionX
	 *            : position x
	 * @param positionY
	 ...
	 * @param damage
	 */
	public Cute(int positionX, int positionY, int hp, int speed, int damage) {
	...
	protected void loadIdleLeft() {
		...
		this.idleLeft = new Animation(RenderableHolder.getInstance().cuteMonsterSprite, frameWidth, frameHeight,
				idleFrameCount, 2, 3);
	...
	protected void loadIdleRight() {
		// TODO Auto-generated method stub
		this.idleRight = new Animation(RenderableHolder.getInstance().cuteMonsterSprite, frameWidth, frameHeight,
				idleFrameCount, 2, 0);
	...
	protected void loadWalkLeft() {
		// TODO Auto-generated method stub
		this.walkLeft = new Animation(RenderableHolder.getInstance().cuteMonsterSprite, frameWidth, frameHeight,
				walkFrameCount, 2, 4);
	...
	protected void loadWalkRight() {
		// TODO Auto-generated method stub
		this.walkRight = new Animation(RenderableHolder.getInstance().cuteMonsterSprite, frameWidth, frameHeight,
				walkFrameCount, 2, 1);
	...
	protected void loadAttackLeft() {
		// TODO Auto-generated method stub
		this.attackLeft = new SequenceAnimation(RenderableHolder.getInstance().cuteMonsterSprite, frameWidth,
				frameHeight, attackFrameCount, 2, 5);
	...
	protected void loadAttackRight() {
		// TODO Auto-generated method stub
		this.attackRight = new SequenceAnimation(RenderableHolder.getInstance().cuteMonsterSprite, frameWidth,
